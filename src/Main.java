public class Main {
    public static void main(String[] args) {
        ...
        Comprador x = new Comprador(new Moneda100(),1,b);
        Comprador y = new Comprador(new Moneda1000(),2,b);
        Comprador z = new Comprador(new Moneda1000(),3,b);
        Comprador a = new Comprador(new Moneda500(),4,b);
        Comprador d = new Comprador(new Moneda500(),4,b);
        ...
        System.out.println("vuelto:"+f.cuantoVuelto());
        System.out.println("vuelto:"+y.cuantoVuelto());
        System.out.println("vuelto:"+g.cuantoVuelto());
        System.out.println("vuelto:"+h.cuantoVuelto());

        System.out.println(p.QueProducto());
        System.out.println(d.QueProducto());
